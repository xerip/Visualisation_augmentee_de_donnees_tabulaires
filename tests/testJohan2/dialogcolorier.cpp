    ...
    QDialog(parent)
{
    ...
    //connect( myPushButtonAppliquer, SIGNAL(change_text(QString)), this, SLOT(on_message_erreur(QString)) );
    //connect( this, SIGNAL(clicked()), this, SLOT(on_message_erreur(QString)) );
...
void DialogColorier::on_message_erreur(QString value)
{
    ...
    //_myLabelError->setPalette(QColor(255, 0, 0));
    //_myLabelError->setfore;
}
